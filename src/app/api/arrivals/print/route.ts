...
export async function GET(request: Request) {
    try {
        ...
        let targetDate = dateParam || getTodayItaly();

        // Get arrivals (bookings starting within targetDate)
        ...
        // Filter arrivals: start date matches targetDate
        ...
        return NextResponse.json({ date: targetDate, arrivals });
